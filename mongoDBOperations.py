...
class MongoDBManagement:
    ...
    def __init__(self, username, password):
        ...
        try:
            self.username = "sana"
            self.password = "mylife1tragedy"
            self.url = "mongodb+srv://{}:{}@cluster0.ucs1y.mongodb.net/myFirstDatabase?retryWrites=true&w=majority".format(self.username, self.password)
